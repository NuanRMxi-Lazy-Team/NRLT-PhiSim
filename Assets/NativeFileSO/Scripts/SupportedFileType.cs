...
namespace Keiwando.NFSO {
	...
	public class SupportedFileType {
		...
		/// a PEZ file
		/// </summary>
		public static readonly SupportedFileType Pez = new SupportedFileType {

			Name = "RPE谱面包",
			Extension = "pez",
			Owner = true,
			AppleUTI = "com.phiedit.rpez",
		...
		/// a zip file
		/// </summary>
		public static readonly SupportedFileType Zip = new SupportedFileType {
